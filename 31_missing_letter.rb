...
def missing_letter(word)
    ...
    # Get the value of the proper alphabet 
    # Duplicate the start and end points without the missing letter
    # Subtract from the given array = Output missiing letter
    

    puts (word.min..word.max).to_a - word
